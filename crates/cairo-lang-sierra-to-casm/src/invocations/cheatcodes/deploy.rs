...
pub fn build_deploy(
    ...
    let prepared_contract_address = optional_prepared_contract_address.ok_or(InvocationError::InvalidGenericArg)?;
    ...
    let prepared_class_hash = optional_prepared_class_hash.ok_or(InvocationError::InvalidGenericArg)?;
