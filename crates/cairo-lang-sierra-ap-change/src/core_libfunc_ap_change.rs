...
pub fn core_libfunc_ap_change<InfoProvider: InvocationApChangeInfoProvider>(
    ...
    match libfunc {
        ...
        CoreConcreteLibfunc::Cheatcodes(libfunc) => match libfunc {
            ...
            CheatcodesConcreteLibFunc::DeployCairo0(_) => vec![ApChange::Known(2), ApChange::Known(2)],
            CheatcodesConcreteLibFunc::Prepare(_) => vec![ApChange::Known(5), ApChange::Known(5)],
            CheatcodesConcreteLibFunc::PrepareCairo0(_) => vec![ApChange::Known(5), ApChange::Known(5)],
        },
